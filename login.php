...
<link rel="icon" href="icon.ico" type="image/ico">
  <title>APLIKASI KASIR TOKO Oding Collection</title>
  <meta charset="utf-8">
...
<div class="row justify-content-center">
	...
	<img alt="logo" src="assets/img/logo.png" height="110" width="390"/><p>
        ...
        <div class="text-center small mt-4">
            <p class="text-muted" >Aplikasi kasir © <?php echo date('Y');?> - By : <a href="#" class="span text-primary">Oding Collection</a></p>
        </div>
    </div>
